...
export function useSettingsDb() {
    return {
        ...
        saveSettings: async (data: RowSettingsType) => {
            const updateSql = "UPDATE t_settings SET one_click_publish_enabled = $1, win_service_retry_count = $2, win_service_retry_interval = $3, win_copy_retry_count = $4, win_copy_retry_interval = $5, win_upload_retry_count = $6, win_upload_retry_interval = $7, update_time = $8 WHERE id = 1";
            const insertSql = "INSERT INTO t_settings (id, one_click_publish_enabled, win_service_retry_count, win_service_retry_interval, win_copy_retry_count, win_copy_retry_interval, win_upload_retry_count, win_upload_retry_interval, update_time) VALUES(1, $1, $2, $3, $4, $5, $6, $7, $8)";
            const bindValues = [
